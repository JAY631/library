          ...
          <div className="row">
            <div className="col-6">
              <div className="flex__wrap">
                ...
                <p className="flex__wrap-text">
                  Мы хотим сохранить архитектурный облик города, построив
                  здания, которые станут предметом гордости компании и эталоном
                  будущего строительства.
                </p>
                <p className="flex__wrap-text">
                  Мы верим, что доступность и качество наших квартир гарантируют
                  достойное решение жилищного вопроса горожан.
                </p>
                <p className="flex__wrap-text">
                  Строим города, строим отношения!
                </p>
                <Link className="flex__wrap-btn" to={"/obout"}>
                  О компании
                </Link>
              </div>
            </div>
