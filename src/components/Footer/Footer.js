    ...
    <footer className="footer">
      <div className="container">
          ...
          <div className="col-4 ">
            ...
            <div className="footer__wrap-end">
              ...
              <ul>
                <p>Телефон</p>
                <li>
                  <a>+996 (778) 44-22-44</a>
                </li>
                <li>
                  <a>+996 (553) 44-22-44</a>
                </li>
                <li>
                  <a>+996 (705) 44-22-44</a>
                </li>
              </ul>
            </div>
            <div className="footer__wrap-end">
            ...
            <div className="footer__wrap-end">
              ...
              <ul>
                <p>Телефон</p>
                <li>
                  <a>+996 (775) 33-06-06</a>
                </li>
                <li>
                  <a>+996 (557) 33-06-06</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="row">
          ...
          <a className="piece" href="">
            manager.emakom@gmail.com
          </a>
        </div>
        <hr />
        <div className="row">
          ...
          <div className=" col-4">
            ...
            <ul>
              ...
              <li>
                <a
                  className="map"
                  href="https://jay631.github.io/sales-departments/"
                >
                  ОТДЕЛЫ ПРОДАЖ
                </a>
              </li>
        ...
        <div className="row">
          ...
          <div className="one-piece">
            <div className="link">
              <a
                target="_blank"
                href="https://api.whatsapp.com/send/?phone=996502441144&text&app_absent=0"
              >
                <i className="fa-brands fa-whatsapp"></i>
              </a>
              <a
                target="_blank"
                href="https://www.instagram.com/emakom_kg/?hl=ru"
              >
                <i className="fa-brands fa-instagram"></i>
              </a>
              <a target="_blank" href="https://www.facebook.com/emakomholding/">
